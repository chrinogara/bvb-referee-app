...
import { useClaudeTranslate } from '../hooks/useClaudeTranslate'
...
export default function Evaluate() {
  ...
  const {
    ...
    loading: generalNotesLoading,
  } = useClaudeTranslate(generalNotes)
  ...
  const handleGeneralNotesChange = (e) => {
    const newValue = e.target.value
    setGeneralNotesValue(newValue)
    setGeneralNotes(newValue)
  }

  const handleAcceptGeneralNotesSuggestion = () => {
...
Italian text: "${text}"`,
  ...
  async function translatePayload(payloadToTranslate) {
    const translated = { ...payloadToTranslate }

    // Translate all criterion notes
    const noteFields = [
      'note_positioning',
      'note_signals',
      'note_attitude',
  ...
  async function handleSave() {
    ...
    try {
      ...
      const translatedPayload = await translatePayload(payload)
        ...
        <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
          ...
          <Card>
            ...
            <CardBody>
              ...
              <TranslationSuggestion
                suggestion={generalNotesSuggestion}
                onAccept={handleAcceptGeneralNotesSuggestion}
